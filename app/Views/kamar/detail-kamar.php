    ...
    <div class="row">
        <div class="col">
            <div class="card">
                <div class="row g-0">
                    <div class="col-md-6">
                        <img src="/gambar/<?= $dataKamar[0]['foto']; ?>" width="100%" class="img-fluid text-center rounded" alt="<?= $dataKamar[0]['foto']; ?>">
                    </div>
                    <div class="col-md-6">
                        <div class="card-body">
                            ...
                            <hr>
                            <div class="row">
                                <span class="badge bg-primary"><strong><?= $data_typeKamar[0]['type_kamar']; ?></strong></span>
                                <span class="badge bg-success my-1">Rp <?= number_format($data_typeKamar[0]['harga'], 0, ',', '.'); ?> / malam</span>
                            </div>
                            <div class="row">
                                <div class="col">
                                    <div class="card mt-3">
